/**
 * Created by jqHe on 2017/3/22.
 */
//DS指令集模块
var dsNgApp= angular.module("ds.directives", []);
///去除ds的驼峰名
...
//**********下拉树指令************//
dsNgApp.directive('dsComboTree',function () {
    return {
        restrict : 'AE',
        replace : false,
        ...
        '<div style="max-height:200px;" kendo-tree-view="dsTreeView"' +
        'k-options="options" ' +
                ...
                pre: function($scope, ele, attrs){
                    ...
                    $scope.methods={
                    	...
                    	initValue:function (txt, node) {
                            ...
                            $scope.selectText = txt;
                            $scope.selectItems = vals;
                    	},
                    	//通过值来选择项
                        ...
                        try {
                            if (key.substring(0, 2) == 'ds'
                                ...
                                if ($scope[key]) {
                                    ...
                                    $scope.options[variaName] = val;//将存在的属性值赋值到options中177
                                }
                            }
                        } catch (ex) {
                        }
                    ...
                    function setValue(data,isAdd) {
                        ...
                        if(isAdd){
                            ...
                            for (var i=0;i<$scope.selectItems.length;i++){
                                if($scope.selectItems[i][$scope.options.dataValueField]==data[$scope.options.dataValueField]){
